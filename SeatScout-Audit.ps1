...
Generated by SeatScout v$script:Version &middot; seatscout.dev &middot; This report was produced locally; no tenant data was transmitted.
</footer>
</div></body></html>
"@
...
if ($Lite -or $script:Edition -eq 'Lite') {
    ...
    Write-Host "  and white-label output are in SeatScout Pro -> seatscout.dev" -ForegroundColor Yellow
    Write-Host ""
